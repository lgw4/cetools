...
- [X] T005 [P] [US1] Write failing tests for MARINE_CAREER mustering-out tables — 7 cash entries and 7 material entries matching FR-005, including `material_benefits[6] == "Explorer's Society"` (exact spelling) — in tests/test_marine_career.py
