...
- [x] CHK013 Are difficulty-name matching semantics specified (case sensitivity, whitespace tolerance, abbreviation), given FR-019 requires rejecting any name not on the ladder? [Gap, Spec §FR-014, §FR-019]
  - **Fixed.** FR-014 now requires exact character-for-character matching with no case folding, abbreviation, or whitespace tolerance, so a near miss is reported under FR-019 rather than resolved to a neighboring rung.
