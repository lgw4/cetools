...
> **Project override:** this repo delegates all git operations to the `git-ops`
> agent, so the installed skill at `.claude/skills/speckit-git-commit/SKILL.md`
> replaces the steps below with an Agent hand-off. If you reinstall or update the
> git extension, that skill is regenerated from this file — reapply the override.
